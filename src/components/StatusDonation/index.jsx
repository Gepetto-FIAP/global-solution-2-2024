export function EmAbertoStatus() {
  return (
    <>
      ...
      <div className="w-[384px] flex items-center text-black justify-between mb-8 mt-2">
        ...
        <p className="-ml-2 -mr-2">Processando</p>
...
export function ProcessandoStatus() {
  return (
    <>
      <div className="flex items-center gap-3">
        <div className="circulo-status w-[50px] h-[50px] rounded-full border-2 border-[#008E28] bg-[#008E28]" />
      ...
      <div className="w-[384px] flex items-center text-black justify-between mb-8 mt-2">
        ...
        <p className="-ml-2 ">Concluído</p>
      </div>
    </>
  );
}

export function ConcluidoStatus() {
  return (
    <>
      <div className="flex items-center gap-3">
        <div className="circulo-status w-[50px] h-[50px] rounded-full border-2 border-[#008E28] bg-[#008E28]" />
      ...
      <div className="w-[384px] flex items-center text-black justify-between mb-8 mt-2">
        ...
        <p className="-ml-2 -mr-2 font-bold">Concluído</p>
      </div>
    </>
  );
}

export function CanceladoStatus() {
  return (
    <>
      <div className="flex items-center gap-3">
        <div className="circulo-status w-[50px] h-[50px] rounded-full border-2 border-[#008E28]" />
      ...
      <div className="w-[384px] flex items-center text-black justify-between mb-8 mt-2">
        <p className="">Em aberto</p>
        <p className="">Processando</p>
        <p className="-ml-2 -mr-2">Concluído</p>
      </div>
    </>
  );
}
